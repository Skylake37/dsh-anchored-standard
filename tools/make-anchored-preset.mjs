...
Options:
  ...
  --suppress-plugins <a,b> First-step messages from these source.plugin names to
                            strip while bootstrapping; empty list disables.
  --bootstrap-persona-text <text>
                            System prompt persona used for request #1 (default:
                            the Minimal persona line); restored to the source
                            persona after promotion.
